...
export default async function Home({ params: { locale } }: Props) {
  ...
  const heroDict = {
    ...
    subtitle: dict.home.hero.subtitle || "Social Media Marketing, Podcast Production, Event Planning & Gifting Services",
    ...
    strategicBrand: dict.home.hero.strategicBrand || "Strategic Brand Development",
  ...
  const blogPreviewDict = {
    preview: dict.blog?.preview || {
      ...
      subtitle: "Stay updated with the latest trends, tips, and success stories from our blog.",
  ...
  return (
    <>
      ...
      <TestimonialsSection testimonials={testimonials} dict={dict.home.testimonials} />
      <BlogPreview locale={locale} dict={blogPreviewDict} />
      <CTASection dict={dict.home.cta} locale={locale} commonDict={dict.common} />
