  ...
  const services: Service[] = mediaData?.services as Service[] || [
    {
      ...
      description: servicesDict?.digital_marketing?.description || 
    ...
    },
    {
      ...
      description: servicesDict?.podcast_production?.description || 
    ...
    {
      _id: "default3",
      title: servicesDict?.communications?.title || "COMMUNICATIONS CONSULTANCY",
      description: servicesDict?.communications?.description || 
                  ...
                  <div className="flex items-center mb-4">
                    <div className="w-12 h-12 bg-dark-red/10 rounded-full flex items-center justify-center mr-3">
                      ...
                      >
                        ...
                        {!["mic", "bar-chart", "globe", "message-square"].includes(service.icon || "") && (
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white dark:bg-gray-800 rounded-lg p-6 h-full flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold mb-3">
                  {processSteps?.execution?.title || "Execution & Content Delivery"}
                </h3>
                <p className="text-muted-foreground">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white dark:bg-[#4a2a2a]/80 p-8 rounded-lg shadow-md border border-gray-200 dark:border-dark-red/30">
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1" className="border-b border-gray-200 dark:border-dark-red/20">
                  <AccordionTrigger className="text-lg font-semibold">
                    {faqQuestions?.services?.question || "What services does Elev8 Media offer?"}
                  </AccordionTrigger>
                ...
                <AccordionItem value="item-2" className="border-b border-gray-200 dark:border-dark-red/20">
                  <AccordionTrigger className="text-lg font-semibold">
                    {faqQuestions?.clients?.question || "Do you work with clients outside of Rwanda?"}
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground">
                ...
                <AccordionItem value="item-3" className="border-b border-gray-200 dark:border-dark-red/20">
                  <AccordionTrigger className="text-lg font-semibold">
                    {faqQuestions?.packages?.question || "Can I book one service or do I need a full package?"}
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground">
                ...
                <AccordionItem value="item-4" className="border-b border-gray-200 dark:border-dark-red/20">
                  <AccordionTrigger className="text-lg font-semibold">
                    {faqQuestions?.results?.question || "How do you measure results?"}
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground">
                ...
                <AccordionItem value="item-5" className="border-b-0">
                  <AccordionTrigger className="text-lg font-semibold">
                    {faqQuestions?.client_types?.question || "What types of clients do you usually work with?"}
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground">
