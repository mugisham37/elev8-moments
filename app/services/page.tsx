...
export default async function Elev8MediaPage() {
  ...
  const services: Service[] = mediaData?.services as Service[] || [
    ...
    },
    {
      ...
      description: "End-to-end podcast production services to help you share your expertise and connect with your audience.",
      features: [
        "Ideation & strategy",
    ...
    },
    {
      ...
      description: "Focused on brand image, voice, and external messaging to ensure consistent and impactful communication.",
      features: [
              ...
              <Suspense key={index} fallback={<SkeletonCard />}>
                <div className="bg-white dark:bg-[#4a2a2a] rounded-lg shadow-lg p-5 border border-gray-200 dark:border-dark-red hover:shadow-xl transition-shadow duration-300 h-full">
                  ...
                  <div className="border-t border-gray-200 dark:border-dark-red/20 pt-3">
                    <h4 className="font-semibold text-xs uppercase mb-2 text-dark-red">Services Include:</h4>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="relative group">
              ...
              <div className="relative bg-white dark:bg-gray-800 rounded-lg p-6 h-full flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold mb-3">Discovery & Onboarding</h3>
                <p className="text-muted-foreground">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white dark:bg-gray-800 rounded-lg p-6 h-full flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold mb-3">Audit & Strategy Development</h3>
                <p className="text-muted-foreground">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white dark:bg-gray-800 rounded-lg p-6 h-full flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold mb-3">Execution & Content Delivery</h3>
                <p className="text-muted-foreground">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white dark:bg-gray-800 rounded-lg p-6 h-full flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold mb-3">Reporting & Optimization</h3>
                <p className="text-muted-foreground">
