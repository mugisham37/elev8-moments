                        ...
                        <div className="relative">
                            ...
                            <div className="relative bg-[#efd8c9] p-8">
                                <h2 className="text-[49px] leading-[58.8px] text-[#1e1e1e] uppercase mb-4"
                                    style={{ fontFamily: 'Noiretblanc' }}>grazing tables</h2>
                                <p className="text-[14px] leading-[25.2px] tracking-[1.4px] text-[#1e1e1e] uppercase mb-6 font-medium"
                                    style={{ fontFamily: 'Montserrat' }}>ELEVATE YOUR EVENT TO THE NEXT LEVEL</p>
                                <p className="text-[16px] leading-[25.6px] text-[#1e1e1e] mb-6"
                                    style={{ fontFamily: 'Raleway' }}>At Glam Haus, we go beyond simply arranging meats and
                                    cheeses – we craft stunning, delicious grazing tables that will leave a lasting
                                    impression on your guests. Whether you&apos;re hosting a cozy gathering or making a big
                                    business pitch, our team is here to bring your vision to life with creative,
                                    mouthwatering presentations. Let us handle the details while you enjoy the wow
                                    factor!</p><a href="#"
                                    className="inline-block border border-[#1e1e1e] px-8 py-4 hover:bg-[#1e1e1e] hover:text-[#f9f2ec] transition-colors"><span
                                        ...
                                        style={{ fontFamily: 'Raleway' }}>REQUEST AN ORDER</span></a>
                            </div>
                        </div>
                    </div>
                </div>
